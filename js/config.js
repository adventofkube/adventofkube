...
export const DAYS = [
  {
    ...
    setup: [
      '<strong>1. Install Docker Desktop</strong>',
      '<span class="os-note"><strong>Windows:</strong> Download <a href="https://docs.docker.com/desktop/install/windows-install/" target="_blank" rel="noopener">Docker Desktop</a>. Enable WSL2 during installation.</span>',
      '<span class="os-note"><strong>Mac:</strong> Download <a href="https://docs.docker.com/desktop/install/mac-install/" target="_blank" rel="noopener">Docker Desktop</a> or run <code>brew install --cask docker</code></span>',
      '<span class="os-note"><strong>Linux:</strong> Install <a href="https://docs.docker.com/engine/install/" target="_blank" rel="noopener">Docker Engine</a> and start the service.</span>',
      '<code>docker --version</code>',
      '<strong>2. Install kubectl</strong>',
      '<span class="os-note"><strong>Windows:</strong> <code>choco install kubernetes-cli</code> or <code>scoop install kubectl</code></span>',
      '<span class="os-note"><strong>Mac:</strong> <code>brew install kubectl</code></span>',
      '<span class="os-note"><strong>Linux:</strong> See <a href="https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/" target="_blank" rel="noopener">kubectl install guide</a></span>',
      '<code>kubectl version --client</code>',
      '<strong>3. Install kind</strong>',
      '<span class="os-note"><strong>Windows:</strong> <code>choco install kind</code> or <code>scoop install kind</code></span>',
      '<span class="os-note"><strong>Mac:</strong> <code>brew install kind</code></span>',
      '<span class="os-note"><strong>Linux:</strong> See <a href="https://kind.sigs.k8s.io/docs/user/quick-start/#installation" target="_blank" rel="noopener">kind install guide</a></span>',
      '<code>kind --version</code>',
      '<strong>4. Install Helm</strong>',
      '<span class="os-note"><strong>Windows:</strong> <code>choco install kubernetes-helm</code> or <code>scoop install helm</code></span>',
      '<span class="os-note"><strong>Mac:</strong> <code>brew install helm</code></span>',
      '<span class="os-note"><strong>Linux:</strong> See <a href="https://helm.sh/docs/intro/install/" target="_blank" rel="noopener">Helm install guide</a></span>',
      ...
      '<strong>7. Get the flag from the pod logs</strong>',
